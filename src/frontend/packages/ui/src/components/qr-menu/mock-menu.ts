// Mock del menu del QR — espejo del seed real del cliente (nombres/precios/tiempos
// de las capturas del client-app) + pastas/bebidas/postres para llenar las tabs.
