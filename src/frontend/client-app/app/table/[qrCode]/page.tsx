...
export default function TablePage() {
  ...
  useEffect(() => {
    if (error) {
      ...
      toast.error('Mesa no encontrada. Por favor, escanea nuevamente el código QR.');
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-700">Cargando información de la mesa...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 flex items-center justify-center">
        <div className="text-center p-8 bg-white rounded-2xl shadow-xl max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Mesa no encontrada</h2>
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full animate-fade-in">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 bg-green-100 text-green-800 px-4 py-2 rounded-full">
            ...
            <span className="font-medium">Mesa lista para ordenar</span>
          </div>
        </div>
