...
const APP_KEY = 'cashier';
const APP_TITLE = 'Caja';
const ACCEPTED_ROLES = ['Cashier'];
const ACCENT = 'from-amber-600 to-yellow-600';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-white to-yellow-50 px-4 py-8">
