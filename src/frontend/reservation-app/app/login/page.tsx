...
const APP_KEY = 'reservation';
const APP_TITLE = 'Gestión de Reservaciones';
const ACCEPTED_ROLES = ['Host', 'Hostess', 'Manager'];
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 via-white to-fuchsia-50 px-4 py-8">
        ...
        <form onSubmit={onSubmit} className="bg-white rounded-2xl shadow-xl p-8 space-y-4 border border-gray-100">
          ...
          <div>
            ...
            <input id="email" type="email" required value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="username"
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-500 text-gray-900"
              placeholder="host@smartmenu.com" />
          </div>
          <div>
